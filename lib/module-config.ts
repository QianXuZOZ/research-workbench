...
export type ModuleConfig = { type: "projects" | "papers" | "literature" | "questions" | "hypotheses" | "experiments" | "runs" | "findings" | "artifacts" | "patents" | "growth"; title: string; singular: string; description: string; addLabel: string; emptyTitle: string; emptyDescription: string; fields: FieldConfig[]; columns: { key: string; label: string }[]; statusOptions: [string, string][] };
...
export const modules: Record<string, ModuleConfig> = {
  ...
  questions: {
    ...
    columns: [{ key: "title", label: "研究问题" }, { key: "status", label: "状态" }, { key: "projectId", label: "项目 ID" }],
    fields: [{ key: "title", label: "问题", required: true, wide: true }, { key: "projectId", label: "所属项目 ID" }, { key: "status", label: "状态", type: "select", options: [["open", "待研究"], ["investigating", "研究中"], ["answered", "已回答"], ["parked", "暂缓"]] }, { key: "context", label: "研究背景", type: "textarea", wide: true }, { key: "successCriteria", label: "回答/验证标准", type: "textarea", wide: true }, { key: "keywords", label: "关键词", wide: true }, { key: "notes", label: "备注", type: "textarea", wide: true }],
  },
  hypotheses: {
    ...
    columns: [{ key: "title", label: "假设" }, { key: "status", label: "状态" }, { key: "projectId", label: "项目 ID" }],
    fields: [{ key: "title", label: "假设", required: true, wide: true }, { key: "projectId", label: "所属项目 ID" }, { key: "questionId", label: "研究问题 ID" }, { key: "status", label: "状态", type: "select", options: [["proposed", "待验证"], ["testing", "验证中"], ["supported", "支持"], ["rejected", "否定"], ["revised", "已修订"]] }, { key: "rationale", label: "理论依据", type: "textarea", wide: true }, { key: "prediction", label: "可验证预测", type: "textarea", wide: true }, { key: "keywords", label: "关键词", wide: true }, { key: "notes", label: "备注", type: "textarea", wide: true }],
  },
  experiments: {
    ...
    fields: [{ key: "title", label: "实验名称", required: true, wide: true }, { key: "projectId", label: "所属项目 ID" }, { key: "hypothesisId", label: "假设 ID" }, { key: "status", label: "状态", type: "select", options: [["planned", "计划"], ["running", "进行中"], ["completed", "完成"], ["failed", "失败"], ["cancelled", "取消"]] }, { key: "platform", label: "实验平台", placeholder: "MATLAB / PSCAD / ADPSS / HIL" }, { key: "method", label: "实验方法", type: "textarea", wide: true }, { key: "variables", label: "变量与工况", type: "textarea", wide: true }, { key: "expectedResult", label: "预期结果", type: "textarea", wide: true }, { key: "keywords", label: "关键词", wide: true }, { key: "notes", label: "备注", type: "textarea", wide: true }],
  },
  runs: {
  ...
  findings: {
    ...
    fields: [{ key: "title", label: "发现标题", required: true, wide: true }, { key: "projectId", label: "所属项目 ID" }, { key: "experimentId", label: "实验 ID" }, { key: "runId", label: "运行 ID" }, { key: "status", label: "状态", type: "select", options: [["candidate", "候选"], ["validated", "已验证"], ["contradicted", "被否定"], ["published", "已发表"]] }, { key: "confidence", label: "置信度 (%)", type: "number" }, { key: "claim", label: "核心结论", type: "textarea", wide: true }, { key: "evidence", label: "证据", type: "textarea", wide: true }, { key: "keywords", label: "关键词", wide: true }, { key: "notes", label: "备注", type: "textarea", wide: true }],
  },
  artifacts: {
