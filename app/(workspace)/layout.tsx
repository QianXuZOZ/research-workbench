...
export default async function WorkspaceLayout({ children }: { children: React.ReactNode }) {
  ...
  const settings = getAppSettings(["workbenchName","displayName","timezone","themePreset","themeMode","themeOverrides"]);
  const workbenchName = settings.workbenchName?.trim() || DEFAULT_WORKBENCH_NAME;
